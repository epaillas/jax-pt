...
def main() -> None:
    ...
    classpt_p2 = np.asarray(cosmo.pk_gg_l2(params.b1, params.b2, params.bG2, params.bGamma3, params.cs2, params.b4))
    classpt_p4 = np.asarray(cosmo.pk_gg_l4(params.b1, params.b2, params.bG2, params.bGamma3, params.cs4, params.b4))

    spectra = [
        ("P0", np.asarray(native.p0), classpt_p0),
        ("P2", np.asarray(native.p2), classpt_p2),
        ("P4", np.asarray(native.p4), classpt_p4),
    ]
